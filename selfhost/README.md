...
+ **LSP** + **`lex` unificado** (`lexcli`) + **arrow functions + captura** (A) +
**`any`/boxing** (B) + **`lex test` self-hostado** (`lextest`, C — as 12 suítes
passam SEM o Rust) em lex: ~4900 linhas, **306 asserções** + ponto-fixo
(`bootstrap.sh`) + smokes. Caminhos:
