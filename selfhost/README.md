...
+ **LSP** + **`lex` unificado** (`lexcli`) + **arrow functions** (A) + **`any`/boxing**
(B) + **`lex test` self-hostado** (`lextest`, C) em lex: ~4800 linhas, **306 asserções
verdes** + ponto-fixo de self-hosting (`bootstrap.sh`) + smokes. Três caminhos:
